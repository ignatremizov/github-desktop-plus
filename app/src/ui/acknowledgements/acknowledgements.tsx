...
const WebsiteURL = 'https://github.com/ignatremizov/github-desktop-plus'
const RepositoryURL = 'https://github.com/ignatremizov/github-desktop-plus'
  ...
  public render() {
    ...
    return (
      ...
      >
        <DialogContent>
          <p>
            <LinkButton uri={WebsiteURL}>GitHub Desktop Plus</LinkButton> is an open
          ...
          <p>GitHub Desktop Plus also distributes these libraries:</p>
