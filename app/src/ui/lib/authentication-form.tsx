...
export const BrowserRedirectMessage =
  "Your browser will redirect you back to Ignat's GitHub Desktop Plus once you've signed in. If your browser asks for your permission to launch Ignat's GitHub Desktop Plus please allow it to."
