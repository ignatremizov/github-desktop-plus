...
> {
      ...
      return (
        <DialogContent className="copilot-tab">
          <div className="copilot-tab-content">
            ...
            {this.renderCustomizationHints()}
          </div>
        </DialogContent>
      )
    }

    const onModelsTab = this.state.selectedTabIndex === 0
    ...
    return (
      <DialogContent className="copilot-tab">
        ...
        <div className="copilot-tab-content">
          ...
          {onModelsTab && this.renderCustomizationHints()}
        </div>
      </DialogContent>
    )
  }
    ...
    return (
      <>
        ...
        <div className="copilot-customization-hints">
          <p>
            Commit messages generated by Copilot can be customized in different
            ways.{' '}
  ...
  private renderCustomizationHints() {
    return (
      <div className="copilot-customization-hints">
        <p>
