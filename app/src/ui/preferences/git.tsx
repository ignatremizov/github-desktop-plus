      ...
      <>
        {__FLATPAK__ && (
          <div className="git-hooks-flatpak-warning">
            ...
            instead. See the{' '}
            <LinkButton uri="https://github.com/ignatremizov/github-desktop-plus#download-and-installation-">
        ...
        <p id="git-hooks-env-description" className="settings-description">
          When enabled, Ignat's GitHub Desktop Plus will attempt to load
          environment variables from your shell when executing Git hooks. This
          is useful if your Git hooks depend on environment variables set in
          your shell configuration files, a common practice for version managers
